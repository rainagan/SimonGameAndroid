...
public class sixButtonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_but6);
        ...
        c4 = (Button) findViewById(R.id.but1_cb4);
        c5 = (Button) findViewById(R.id.but1_cb5);
        c6 = (Button) findViewById(R.id.but1_cb6);
        ...
        main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(sixButtonActivity.this, welcomeActivity.class));
            }
        });
        ...
        for (int i = 0; i < model.getLength(); i++) {
            ...
            if (b == 1) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // pressed button look
                        c4.setBackgroundResource(R.drawable.solidcircle);
                        handler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                // released button lock
                                c4.setBackgroundResource(R.drawable.circleshape);
                            }
                        }, 1000 / model.getIDiff());
                    }
                }, delay);
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // pressed button look
                        c5.setBackgroundResource(R.drawable.solidcircle);
                        handler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                // released button lock
                                c5.setBackgroundResource(R.drawable.circleshape);
                            }
                        }, 1000 / model.getIDiff());
                    }
                }, delay);
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // pressed button look
                        c6.setBackgroundResource(R.drawable.solidcircle);
                        handler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                // released button lock
                                c6.setBackgroundResource(R.drawable.circleshape);
                            }
                        }, 1000 / model.getIDiff());
                    }
                }, delay);
